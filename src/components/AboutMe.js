...
import avatar from "../files/1.jpeg";
        ...
        <div className="about-me-section">
            ...
            <div className="about-me-subsection">
                ...
                <div className="about-me-content about-content-sections">
                    <p>Hi! My name is Inês (Portuguese pronunciation: <a href="https://translate.google.com/?sl=auto&tl=pt&text=In%C3%AAs&op=translate" target="_blank" rel="noopener noreferrer">iˈneʃ</a>). I'm 29 years old and live in London, UK.</p>
                    ...
                    <p>My hobbies include reading, going to the gym and playing on my Switch. I also enjoy listening to the occasional podcast - <a href="https://softskills.audio/" target="_blank" rel="noopener noreferrer">Soft Skills Engineering</a> and <a href="https://open.spotify.com/show/0xDEeqWuoMNBUFGNrhIz6L" target="_blank" rel="noopener noreferrer">It's Always Sunny</a> being my favorites at the moment.</p>
                    <p>I'm not currently looking for new opportunities, but feel free to <a href="mailto:ines.csim@gmail.com" alt="">say hi</a>!</p>
