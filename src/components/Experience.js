...
const content = {
    en: [
        ...
        },
        {
            ...
            description: ["Collaboration with The Loop Co to develop babyloop.pt, a platform to buy and sell used baby products (such as cribs, car seats, etc).", "During my time at HYP I worked closely with a small team of developers and designers."],
            company: "HYP",
...
const Experience = ({ useEnglishLanguage }) => {
    let experienceContent = useEnglishLanguage ? content.en : content.pt;
    const renderedExperienceItems = experienceContent.map((c) => {
        return (
